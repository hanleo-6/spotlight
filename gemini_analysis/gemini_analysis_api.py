...
GCS_INPUT_PREFIX = "gemini_inputs"
OUTPUT_DIR = Path("data/output/gemini_analysis")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

# Consolidated output directory for template database
TEMPLATE_DB_DIR = Path("data/output/template_database")
                ...
                if "frame" in item:
                    ...
                    if "/frames/" in frame_uri:
                        ...
                        if len(parts) >= 3:
                            ...
                            # Construct new URI
                            item["frame"] = f"gs://{BUCKET_NAME}/gemini_inputs/{username}/{video_id}/frames/{filename}"
