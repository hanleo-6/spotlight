...
# Local paths
ALIGNMENT_DIR = Path("data/output/frame_mappings/")
OUTPUT_DIR = Path("data/output/gemini_inputs/")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

# GCS bucket path for frame URIs
GCS_BUCKET = "gs://spotlight-analysis-videos-ig/frames"
