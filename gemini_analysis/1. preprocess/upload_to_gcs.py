...
BUCKET_NAME = "spotlight-analysis-videos-tiktok-ew4"
LOCAL_INPUT_DIR = Path("data/output/gemini_inputs/tiktok_vids")
LOCAL_FRAMES_DIR = Path(f"data/output/keyframes/{DATA_SOURCE}")
...
def upload_json_files():
    ...
    for json_file in json_files:
        ...
        gcs_path = f"gemini_inputs/{DATA_SOURCE}/{relative_path.as_posix()}"
...
def upload_frame_images():
    ...
    for frame_file in frame_files:
        ...
        if len(parts) >= 3:
            ...
            # Upload to gemini_inputs/DATA_SOURCE/username/video_id/frames/filename
            gcs_path = f"gemini_inputs/{DATA_SOURCE}/{username}/{video_id}/frames/{filename}"
